...
@implementation GradientButton2
...
- (void)useColorStyle
{
    ...
    UIColor *color = [UIColor colorWithRed:200.0f/255.0f green:50.0f/255.0f blue:50.0f/255.0f alpha:1.0f];
    UIColor *color2 = [UIColor colorWithRed:175.0f/255.0f green:50.0f/255.0f blue:50.0f/255.0f alpha:1.0f];
    UIColor *color3 = [UIColor colorWithRed:150.0f/255.0f green:50.0f/255.0f blue:50.0f/255.0f alpha:1.0f];
    UIColor *color4 = [UIColor colorWithRed:125.0f/255.0f green:50.0f/255.0f blue:50.0f/255.0f alpha:1.0f];
    NSMutableArray *colors = [NSMutableArray arrayWithCapacity:4];
    [colors addObject:(id)[color CGColor]];
    ...
    NSMutableArray *colors2 = [NSMutableArray arrayWithCapacity:4];
    [colors2 addObject:(id)[color4 CGColor]];
    [colors2 addObject:(id)[color CGColor]];;
    [colors2 addObject:(id)[color CGColor]];
    [colors2 addObject:(id)[color4 CGColor]];
